...
export default class Media {
  ...
  update(scroll, direction) {
    ...
    this.program.uniforms.uHoverIntensity.value = this.hoverIntensity;
  ...
  setHover(isHovered) {
    ...
    this.program.uniforms.uIsHovered.value = isHovered ? 1.0 : 0.0;
  }

  setBlackout(intensity) {
    this.program.uniforms.uBlackoutIntensity.value = intensity;
  }
}
